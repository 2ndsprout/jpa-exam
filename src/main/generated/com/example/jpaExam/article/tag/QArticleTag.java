...
public class QArticleTag extends EntityPathBase<ArticleTag> {
    ...
    private static final long serialVersionUID = -1720424043L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QArticleTag articleTag = new QArticleTag("articleTag");

    public final com.example.jpaExam.article.QArticle article;
    ...
    public QArticleTag(Class<? extends ArticleTag> type, PathMetadata metadata, PathInits inits) {
        ...
        this.article = inits.isInitialized("article") ? new com.example.jpaExam.article.QArticle(forProperty("article"), inits.get("article")) : null;
